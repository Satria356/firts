...
exports.limitg= (prefix) =>{
	return` ♻️️ Limit game kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`
}
exports.event = (prefix) =>{
	return` 🌹 Event grup belum di aktifkan, kirim perintah ${prefix}event on untuk mengaktifkan`
}
exports.wait = () => {
	return `\`\`\`[ ! ] Proses kak...\`\`\``
	}
...
exports.wrongFormat = () => {
	return `♻️ Format salah, coba liat lagi di menu`
	}
exports.erorStik = () => {
...
exports.noteks = (prefix, command) => {
	return `♻️ Example ${prefix + command} zeeone`
	}
exports.botNotAdm = () => {
